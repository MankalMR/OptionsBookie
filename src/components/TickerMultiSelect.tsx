...
export default function TickerMultiSelect({
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        <Card className="absolute top-full left-0 right-0 mt-1 z-50 shadow-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 max-h-80 overflow-y-auto">
          <CardContent className="p-2 bg-white dark:bg-gray-900">
            {/* Header with Select All / Clear All */}
            <div className="flex justify-between items-center mb-2 pb-2 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-900 z-10 pt-1">
              <Button
                variant="ghost"
                size="sm"
